...
لطفا فعلا از پرداخت کریپتو استفاده نکنید فعلا در حال بررسی و رفع باگ هستیم، ولی با خیال راحت از روش کارت به کارت استفاده کنید⛔
---
...
```bash
sudo bash -c 'git clone https://github.com/MNSH-Nexo/Nexora-Bot-Panel.git /opt/nexora-bot && bash /opt/nexora-bot/install.sh'
```
