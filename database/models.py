...
class User(Base):
    ...
    is_banned: Mapped[bool] = MappedColumn(Boolean, default=False, nullable=False)
...
class Ticket(Base):
    ...
    # اگر True باشد این تیکت توسط ادمین برای کاربر باز شده (نه توسط کاربر)
    initiated_by_admin: Mapped[bool] = MappedColumn(Boolean, default=False, nullable=False)
